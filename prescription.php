...
<html>
<head>
<title><?php echo $user;?> Medi Store</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/l.png"></a> <br><span id="medi"> Medi Store Pharmacist  </span> </h1></div>
<div id="left_column">
<div id="button">
		<ul>
...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($conn,"SELECT * FROM prescription")or die(mysqli_error());
        ...
        echo "<tr> <th>Customer</th><th>Prescription No</th> <th>Invoice No</th><th>Date </th><th>Delete</th></tr>";
			...
			$(document).ready(function()
	{
		...
		<form name="myform" onsubmit="return validateForm(this);" action="invoice.php" method="post" >
			<table width="200" height="106" border="0" >	
				...
				<tr><td align="left"><input name="age" type="age" style="width:170px" id="age" placeholder="Age"required="required" /></td></tr>
...
<div id="footer" align="Center"><br> Medi Store 2020. Copyright All Rights Reserved</div>
</div>
</body>
</html>
