...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/l.png"></a> <br><span id="medi">Medi Store Admin </span></h1></div>
<div id="left_column">
<div id="button">
<ul>
...
?> 
		...
		<form name="form1"  onsubmit="return validateForm(validation_script.js);" action="admin_cashier.php" method="post" >
			<table width="250" height="116" border="0" >	
				<tr><td align="center"><input name="first_name" type="text" style="width:170px height:50px" placeholder="First Name" required="required"  id="first_name" /></td></tr>
